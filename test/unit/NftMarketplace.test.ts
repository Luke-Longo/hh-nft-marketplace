...
//                   //   ).to.be.reverted("AlreadyListed")
//                   await expect(nftMarketplace.listItem(basicNft.address, TOKEN_ID, PRICE)).to.be
//                       .reverted
//               })
...
//                   await expect(nftMarketplace.cancelListing(basicNft.address, TOKEN_ID)).to.be
//                       .reverted
//               })
...
//                   await expect(nftMarketplace.updateListing(basicNft.address, TOKEN_ID, PRICE)).to
//                       .be.reverted
//                   await nftMarketplace.listItem(basicNft.address, TOKEN_ID, PRICE)
//                   nftMarketplace = nftMarketplaceContract.connect(user)
//                   await expect(nftMarketplace.updateListing(basicNft.address, TOKEN_ID, PRICE)).to
